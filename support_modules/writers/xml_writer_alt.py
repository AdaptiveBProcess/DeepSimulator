# -*- coding: utf-8 -*-
"""
Created on Mon Nov 15 15:59:04 2021
...
class XesWriter(object):  # TODO: it makes sense to save data also with LogReader instead of a separate class
    ...
    def __init__(self, log: Union[lr.LogReader, pd.DataFrame, list], read_options, output_path):
        if isinstance(log, pd.DataFrame):
            self.log = log.values
        elif isinstance(log, lr.LogReader):
            self.log = log.data
