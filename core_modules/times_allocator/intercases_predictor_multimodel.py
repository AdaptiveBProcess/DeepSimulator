...
class DualIntercasesPredictor():
    ...
    def __init__(self, model_path, parms):
        ...
        self.parms = parms
        self.n_feat_proc = (self.proc_model_path
                           .get_layer('features')
                           .output_shape[0][2])
        self.n_feat_wait = (self.wait_model_path
                           .get_layer('features')
                           .output_shape[0][2])
    ...
    def predict(self, sequences, iarr):
        ...
        self.sequences, num_elements = self._encode_secuences(
            sequences, self.ac_index, rl_task, rl_table)
